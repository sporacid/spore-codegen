...
{
    struct codegen_condition_cpp_attribute : codegen_condition<cpp_file>
    {
        ...
        static std::shared_ptr<codegen_condition_cpp_attribute> make_condition(const nlohmann::json& data)
        {
            std::shared_ptr<codegen_condition_cpp_attribute> condition = std::make_shared<codegen_condition_cpp_attribute>();
