function(spore_codegen SPORE_TARGET_NAME)
  cmake_parse_arguments(
    "SPORE_CODEGEN"
    "DEBUG;FORCE;REFORMAT"
    "CONFIG;CACHE;CXX_STANDARD;TARGET_NAME;BIN_NAME;DUMP_AST;OUTPUT;WORKING_DIRECTORY;PARALLELISM;CLANG"
    "DEFINITIONS;INCLUDES;USER_DATA;TEMPLATE_PATHS"
    ${ARGN}
  )
  ...
  if (NOT SPORE_CODEGEN_CLANG)
    find_package(Clang++)
    if (NOT CLANG_PP_FOUND)
      message(FATAL_ERROR "clang++ executable could not be found.")
      return()
    else()
      set(SPORE_CODEGEN_CLANG ${CLANG_PP_EXECUTABLE})
    endif ()
  endif ()
  ...
  if (NOT SPORE_CODEGEN_PARALLELISM)
    include(ProcessorCount)
    ProcessorCount(SPORE_CODEGEN_HARDWARE_PARALLELISM)
    set(SPORE_CODEGEN_PARALLELISM $<TARGET_PROPERTY:${SPORE_TARGET_NAME},CXX_STANDARD>)
  endif ()
