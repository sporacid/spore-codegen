function(spore_codegen SPORE_TARGET_NAME)
  cmake_parse_arguments(
    "SPORE_CODEGEN"
    "FORCE;DEBUG;"
    "CONFIG;CACHE;TARGET_NAME;BIN_NAME;OUTPUT;REFORMAT;WORKING_DIRECTORY;"
  ...
  add_custom_target(
    ...
    COMMAND
      ...
      "--"
      "$<$<BOOL:${SPORE_CODEGEN_CXX_STANDARD}>:-std=c++${SPORE_CODEGEN_CXX_STANDARD}>"
      "$<$<BOOL:$<FILTER:${SPORE_CODEGEN_INCLUDES},EXCLUDE,^$>>:-I$<JOIN:${SPORE_CODEGEN_INCLUDES},;-I>>"
      "$<$<BOOL:$<FILTER:${SPORE_CODEGEN_SYSTEM_INCLUDES},EXCLUDE,^$>>:-isystem$<JOIN:${SPORE_CODEGEN_SYSTEM_INCLUDES},;-isystem>>"
      "$<$<BOOL:$<FILTER:${SPORE_CODEGEN_DEFINITIONS},EXCLUDE,^$>>:-D$<JOIN:${SPORE_CODEGEN_DEFINITIONS},;-D>>"
